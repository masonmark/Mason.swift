...
//  macOSTestApp
//
//  Created by mason on 2016-08-10.
//  Copyright © 2016 MASON MARK (.COM). All rights reserved.
//
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "macOSTestApp", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        if failError == nil {
            ...
            let url = self.applicationDocumentsDirectory.appendingPathComponent("macOSTestApp.storedata")
            do {
